###########################################################################
## Makefile generated for component 'q_gyro'. 
## 
## Makefile     : q_gyro.mk
## Generated on : Thu Feb 06 13:17:27 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_gyro.rt-win64
...
COMPILER_COMMAND_FILE     = q_gyro_comp.rsp
CMD_FILE                  = q_gyro.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_gyro.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_gyro -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_gyro_quarc_win64\q_gyro.c $(START_DIR)\q_gyro_quarc_win64\q_gyro_data.c $(START_DIR)\q_gyro_quarc_win64\q_gyro_main.c $(START_DIR)\q_gyro_quarc_win64\rtGetInf.c $(START_DIR)\q_gyro_quarc_win64\rtGetNaN.c $(START_DIR)\q_gyro_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_gyro.obj q_gyro_data.obj q_gyro_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_gyro_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_gyro_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_gyro.obj : "$(START_DIR)\q_gyro_quarc_win64\q_gyro.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_gyro_quarc_win64\q_gyro.c"


q_gyro_data.obj : "$(START_DIR)\q_gyro_quarc_win64\q_gyro_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_gyro_quarc_win64\q_gyro_data.c"


q_gyro_main.obj : "$(START_DIR)\q_gyro_quarc_win64\q_gyro_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_gyro_quarc_win64\q_gyro_main.c"


rtGetInf.obj : "$(START_DIR)\q_gyro_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_gyro_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_gyro_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_gyro_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_gyro_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_gyro_quarc_win64\rt_nonfinite.c"
