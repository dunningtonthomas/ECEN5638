###########################################################################
## Makefile generated for component 'control_experiment'. 
## 
## Makefile     : control_experiment.mk
## Generated on : Thu Feb 06 14:41:57 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\control_experiment.rt-win64
...
PRODUCT_NAME              = control_experiment
MAKEFILE                  = control_experiment.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\quarc_user\Desktop\GitRepos\ECEN5638\Gyro\ControlDesign
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = control_experiment_comp.rsp
CMD_FILE                  = control_experiment.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\control_experiment.rt-win64
...
DEFINES_STANDARD = -DMODEL=control_experiment -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\control_experiment_quarc_win64\control_experiment.c $(START_DIR)\control_experiment_quarc_win64\control_experiment_data.c $(START_DIR)\control_experiment_quarc_win64\control_experiment_main.c $(START_DIR)\control_experiment_quarc_win64\rtGetInf.c $(START_DIR)\control_experiment_quarc_win64\rtGetNaN.c $(START_DIR)\control_experiment_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = control_experiment.obj control_experiment_data.obj control_experiment_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\control_experiment_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\control_experiment_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
control_experiment.obj : "$(START_DIR)\control_experiment_quarc_win64\control_experiment.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\control_experiment_quarc_win64\control_experiment.c"


control_experiment_data.obj : "$(START_DIR)\control_experiment_quarc_win64\control_experiment_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\control_experiment_quarc_win64\control_experiment_data.c"


control_experiment_main.obj : "$(START_DIR)\control_experiment_quarc_win64\control_experiment_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\control_experiment_quarc_win64\control_experiment_main.c"


rtGetInf.obj : "$(START_DIR)\control_experiment_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\control_experiment_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\control_experiment_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\control_experiment_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\control_experiment_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\control_experiment_quarc_win64\rt_nonfinite.c"
