 ...
 * C source code generated on : Thu Feb  6 14:57:55 2025
 *
...
#ifndef control_experiment_h_
#define control_experiment_h_
#ifndef control_experiment_COMMON_INCLUDES_
#define control_experiment_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* control_experiment_COMMON_INCLUDES_ */

#include "control_experiment_types.h"
...
#define control_experiment_rtModel     RT_MODEL_control_experiment_T

/* Block signals (default storage) */
typedef struct {
  real_T thetaR;                       /* '<Root>/Step' */
  real_T HILReadEncoder_o1;            /* '<S1>/HIL Read Encoder' */
  real_T HILReadEncoder_o2;            /* '<S1>/HIL Read Encoder' */
  ...
  real_T DirectionConventionRightHandsys;
                          /* '<S4>/Direction Convention: (Right-Hand) system' */
  real_T AmplifierSaturationV;         /* '<S4>/Amplifier  Saturation (V)' */
  ...
  real_T GYROEcountstorad;             /* '<S1>/GYRO-E: counts to rad' */
  real_T Gearratio;                    /* '<S1>/Gear ratio' */
  real_T Gain_c;                       /* '<S2>/Gain' */
  real_T Gain_i;                       /* '<S3>/Gain' */
  real_T Clock;                        /* '<Root>/Clock' */
} B_control_experiment_T;
...
} DW_control_experiment_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} X_control_experiment_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} XDot_control_experiment_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
} XDis_control_experiment_T;
...
#define rtB                            control_experiment_B
#define BlockIO                        B_control_experiment_T
#define rtX                            control_experiment_X
#define ContinuousStates               X_control_experiment_T
#define rtXdot                         control_experiment_XDot
#define StateDerivatives               XDot_control_experiment_T
#define tXdis                          control_experiment_XDis
#define StateDisabled                  XDis_control_experiment_T
#define rtP                            control_experiment_P
#define Parameters                     P_control_experiment_T
#define rtDWork                        control_experiment_DW
#define D_Work                         DW_control_experiment_T

/* Parameters (default storage) */
struct P_control_experiment_T_ {
...
struct tag_RTM_control_experiment_T {
  const char_T *path;
...
extern P_control_experiment_T control_experiment_P;

/* Block signals (default storage) */
extern B_control_experiment_T control_experiment_B;

/* Continuous states (default storage) */
extern X_control_experiment_T control_experiment_X;

/* Disabled states (default storage) */
extern XDis_control_experiment_T control_experiment_XDis;

/* Block states (default storage) */
extern DW_control_experiment_T control_experiment_DW;

/* Model entry point functions */
extern void control_experiment_initialize(void);
extern void control_experiment_output(void);
extern void control_experiment_update(void);
extern void control_experiment_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern control_experiment_rtModel *control_experiment(void);
...
extern RT_MODEL_control_experiment_T *const control_experiment_M;
 ...
 *
 * '<Root>' : 'control_experiment'
 * '<S1>'   : 'control_experiment/SRV02 Gyroscope'
 * '<S2>'   : 'control_experiment/alpha: rad to deg'
 * '<S3>'   : 'control_experiment/theta:  rad to deg'
 * '<S4>'   : 'control_experiment/SRV02 Gyroscope/Actuator Dynamics'
 */
#endif                                 /* control_experiment_h_ */
