...
RT_MODEL_SRV02_systemID_T *SRV02_systemID(void)
{
  ...
  /* External mode info */
  SRV02_systemID_M->Sizes.checksums[0] = (4072827957U);
  SRV02_systemID_M->Sizes.checksums[1] = (691424057U);
  SRV02_systemID_M->Sizes.checksums[2] = (3721652860U);
  SRV02_systemID_M->Sizes.checksums[3] = (2125316069U);
  ...
  SRV02_systemID_M->Sizes.numBlockPrms = (173);/* Sum of parameter "widths" */
