 ...
 * C source code generated on : Thu Feb 13 13:21:56 2025
 *
...
#ifndef q_gyro_h_
#define q_gyro_h_
#ifndef q_gyro_COMMON_INCLUDES_
#define q_gyro_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* q_gyro_COMMON_INCLUDES_ */

#include "q_gyro_types.h"
...
#define q_gyro_rtModel                 RT_MODEL_q_gyro_T
...
typedef struct {
  ...
  real_T seps;                         /* '<Root>/Neg. Fdbk' */
  real_T DerivativeGain;               /* '<Root>/Derivative Gain' */
  real_T epsilon;                      /* '<Root>/epsilon = alpha//s' */
...
typedef struct {
  real_T epsilonalphas_CSTATE;         /* '<Root>/epsilon = alpha//s' */
} X_q_gyro_T;
...
/* State disabled  */
typedef struct {
  boolean_T epsilonalphas_CSTATE;      /* '<Root>/epsilon = alpha//s' */
} XDis_q_gyro_T;
...
#define rtB                            q_gyro_B
#define BlockIO                        B_q_gyro_T
#define rtX                            q_gyro_X
#define ContinuousStates               X_q_gyro_T
#define rtXdot                         q_gyro_XDot
#define StateDerivatives               XDot_q_gyro_T
#define tXdis                          q_gyro_XDis
#define StateDisabled                  XDis_q_gyro_T
#define rtP                            q_gyro_P
#define Parameters                     P_q_gyro_T
#define rtDWork                        q_gyro_DW
#define D_Work                         DW_q_gyro_T
...
struct P_q_gyro_T_ {
  ...
  real_T Gearratio_Gain;               /* Expression: 1/4
                                        ...
                                        */
  real_T NegFdbk_Gain;                 /* Expression: -1
                                        * Referenced by: '<Root>/Neg. Fdbk'
                                        */
  real_T epsilonalphas_IC;             /* Expression: 0
                                        * Referenced by: '<Root>/epsilon = alpha//s'
                                        */
  real_T epsilonalphas_UpperSat;       /* Expression: 5*pi/180
                                        * Referenced by: '<Root>/epsilon = alpha//s'
                                        */
  real_T epsilonalphas_LowerSat;       /* Expression: -5*pi/180
                                        * Referenced by: '<Root>/epsilon = alpha//s'
                                        */
...
extern P_q_gyro_T q_gyro_P;

/* Block signals (default storage) */
extern B_q_gyro_T q_gyro_B;

/* Continuous states (default storage) */
extern X_q_gyro_T q_gyro_X;

/* Disabled states (default storage) */
extern XDis_q_gyro_T q_gyro_XDis;

/* Block states (default storage) */
extern DW_q_gyro_T q_gyro_DW;

/* Model entry point functions */
extern void q_gyro_initialize(void);
extern void q_gyro_output(void);
extern void q_gyro_update(void);
extern void q_gyro_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_gyro_rtModel *q_gyro(void);
...
extern RT_MODEL_q_gyro_T *const q_gyro_M;
 ...
 *
 * '<Root>' : 'q_gyro'
 * '<S1>'   : 'q_gyro/SRV02 Gyroscope'
 * '<S2>'   : 'q_gyro/alpha: rad to deg'
 * '<S3>'   : 'q_gyro/theta:  rad to deg'
 * '<S4>'   : 'q_gyro/SRV02 Gyroscope/Actuator Dynamics'
 */
#endif                                 /* q_gyro_h_ */
