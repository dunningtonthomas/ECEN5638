...
[ g, Mr, Lr, lr, Jr, Br ] = config_sp( 'ROTARY_ARM' );
% Load medium 12-inch pendulum parameters
[ g, Mp, Lp, lp, Jp, Bp ] = config_sp( 'MEDIUM_12IN');
...
%% Calculate max linear acceleration
theta_dot_max = 5 / (Kg*km);
u_max = theta_dot_max * Lr;
