###########################################################################
## Makefile generated for component 's_rotpen_bal'. 
## 
## Makefile     : s_rotpen_bal.mk
## Generated on : Tue Mar 18 13:34:53 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\s_rotpen_bal.rt-windows
...
COMPILER_COMMAND_FILE     = s_rotpen_bal_comp.rsp
CMD_FILE                  = s_rotpen_bal.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\s_rotpen_bal.rt-windows
...
DEFINES_STANDARD = -DMODEL=s_rotpen_bal -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\s_rotpen_bal_quarc_windows\rtGetInf.c $(START_DIR)\s_rotpen_bal_quarc_windows\rtGetNaN.c $(START_DIR)\s_rotpen_bal_quarc_windows\rt_nonfinite.c $(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal.c $(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal_data.c $(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj s_rotpen_bal.obj s_rotpen_bal_data.obj s_rotpen_bal_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\s_rotpen_bal_quarc_windows}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\s_rotpen_bal_quarc_windows}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\s_rotpen_bal_quarc_windows\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_rotpen_bal_quarc_windows\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\s_rotpen_bal_quarc_windows\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_rotpen_bal_quarc_windows\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\s_rotpen_bal_quarc_windows\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_rotpen_bal_quarc_windows\rt_nonfinite.c"


s_rotpen_bal.obj : "$(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal.c"


s_rotpen_bal_data.obj : "$(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal_data.c"


s_rotpen_bal_main.obj : "$(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_rotpen_bal_quarc_windows\s_rotpen_bal_main.c"
