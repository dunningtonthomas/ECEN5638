...
#ifndef q_rotpen_bal_student_h_
#define q_rotpen_bal_student_h_
...
extern XDis_q_rotpen_bal_student_T q_rotpen_bal_student_XDis;
 ...
 * '<S4>'   : 'q_rotpen_bal_student/Rotary Pendulum Interface'
 * '<S5>'   : 'q_rotpen_bal_student/Scopes'
 * '<S6>'   : 'q_rotpen_bal_student/Rotary Pendulum Interface/Calculate Upright Angle'
 * '<S7>'   : 'q_rotpen_bal_student/Scopes/alpha: rad to deg'
 * '<S8>'   : 'q_rotpen_bal_student/Scopes/theta: rad to deg'
 */
#endif                                 /* q_rotpen_bal_student_h_ */
