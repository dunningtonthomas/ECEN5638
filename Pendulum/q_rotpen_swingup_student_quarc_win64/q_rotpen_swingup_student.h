...
#ifndef q_rotpen_swingup_student_h_
#define q_rotpen_swingup_student_h_
...
typedef struct {
  ...
  real_T MotorAccelerationLimit;       /* '<S11>/Motor Acceleration Limit' */
...
typedef struct {
  ...
  int32_T sfEvent_h;                   /* '<S13>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit;    /* '<S7>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_g;  /* '<S13>/MATLAB Function' */
...
struct P_q_rotpen_swingup_student_T_ {
  ...
  real_T a_max;                        /* Variable: a_max
                                        * Referenced by: '<S11>/Motor Acceleration Limit'
                                        */
  ...
  real_T ModAnglerad_Value;            /* Expression: 2*pi
                                        * Referenced by: '<S8>/Mod Angle  (rad)'
                                        */
  real_T OffsetAnglerad_Value;         /* Expression: -pi
                                        * Referenced by: '<S8>/Offset Angle  (rad)'
                                        */
  ...
  real_T HPFalpha_dotrads_D;           /* Computed Parameter: HPFalpha_dotrads_D
                                        * Referenced by: '<S3>/HPF: alpha_dot (rad//s)'
                                        */
  real_T u_maxms2_Value;               /* Expression: 2
...
extern XDis_q_rotpen_swingup_student_T q_rotpen_swingup_student_XDis;
 ...
 * '<S4>'   : 'q_rotpen_swingup_student/Rotary Pendulum Interface'
 * '<S5>'   : 'q_rotpen_swingup_student/Scopes'
 * '<S6>'   : 'q_rotpen_swingup_student/Slider Gain'
 * '<S7>'   : 'q_rotpen_swingup_student/Swing-up'
 * '<S8>'   : 'q_rotpen_swingup_student/Rotary Pendulum Interface/Calculate Upright Angle'
 * '<S9>'   : 'q_rotpen_swingup_student/Scopes/alpha: rad to deg'
 * '<S10>'  : 'q_rotpen_swingup_student/Scopes/theta: rad to deg'
 * '<S11>'  : 'q_rotpen_swingup_student/Swing-up/Energy-Based Swing-Up Control'
 * '<S12>'  : 'q_rotpen_swingup_student/Swing-up/MATLAB Function'
 ...
 * '<S15>'  : 'q_rotpen_swingup_student/Swing-up/Energy-Based Swing-Up Control/Pendulum Energy/MATLAB Function'
 */
#endif                                 /* q_rotpen_swingup_student_h_ */
