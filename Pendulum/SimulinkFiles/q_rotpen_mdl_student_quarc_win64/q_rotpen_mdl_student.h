...
#ifndef q_rotpen_mdl_student_h_
#define q_rotpen_mdl_student_h_
 ...
 * '<S1>'   : 'q_rotpen_mdl_student/Radians to Degrees'
 * '<S2>'   : 'q_rotpen_mdl_student/Radians to Degrees1'
 * '<S3>'   : 'q_rotpen_mdl_student/Radians to Degrees2'
 * '<S4>'   : 'q_rotpen_mdl_student/Rotary Pendulum Interface'
 * '<S5>'   : 'q_rotpen_mdl_student/Rotary Pendulum Interface/Calculate Upright Angle'
 */
#endif                                 /* q_rotpen_mdl_student_h_ */
