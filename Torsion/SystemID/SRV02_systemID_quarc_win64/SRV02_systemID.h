...
#ifndef SRV02_systemID_h_
#define SRV02_systemID_h_
#ifndef SRV02_systemID_COMMON_INCLUDES_
#define SRV02_systemID_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* SRV02_systemID_COMMON_INCLUDES_ */

#include "SRV02_systemID_types.h"
...
#define SRV02_systemID_rtModel         RT_MODEL_SRV02_systemID_T
...
typedef struct {
   ...
   */
  real_T SineWave_rtw_collapsed_sub_expr[100];
} ConstP_SRV02_systemID_T;

/* Backward compatible GRT Identifiers */
#define rtB                            SRV02_systemID_B
#define BlockIO                        B_SRV02_systemID_T
#define rtP                            SRV02_systemID_P
...
struct P_SRV02_systemID_T_ {
  ...
  real_T SineWave_Bias;                /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Phase[100];          /* Expression: rand(1,N)*2*pi
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
...
struct tag_RTM_SRV02_systemID_T {
  const char_T *path;
...
extern P_SRV02_systemID_T SRV02_systemID_P;

/* Block signals (default storage) */
extern B_SRV02_systemID_T SRV02_systemID_B;
...
extern void SRV02_systemID_output(void);
extern void SRV02_systemID_update(void);
extern void SRV02_systemID_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern SRV02_systemID_rtModel *SRV02_systemID(void);
...
extern RT_MODEL_SRV02_systemID_T *const SRV02_systemID_M;
 ...
 *
 * '<Root>' : 'SRV02_systemID'
 * '<S1>'   : 'SRV02_systemID/SRV-02'
 */
#endif                                 /* SRV02_systemID_h_ */
