...
void SRV02_systemID_output(void)
{
  ...
  /* Sin: '<Root>/Sine Wave' */
  rtb_HILReadEncoder = SRV02_systemID_M->Timing.t[0];
  ...
  for (i = 0; i < 100; i++) {
     ...
     *  Sin: '<Root>/Sine Wave'
     */
    rtb_SumofElements += sin
      (SRV02_systemID_ConstP.SineWave_rtw_collapsed_sub_expr[i] * 2.0 *
       3.1415926535897931 / SRV02_systemID_P.T * rtb_HILReadEncoder +
       SRV02_systemID_P.SineWave_Phase[i]) * SRV02_systemID_P.SineWave_Amp +
      SRV02_systemID_P.SineWave_Bias;
  }

  /* Saturate: '<Root>/Saturation' */
  if (rtb_SumofElements > SRV02_systemID_P.Saturation_UpperSat) {
    /* Saturate: '<Root>/Saturation' */
    SRV02_systemID_B.Saturation = SRV02_systemID_P.Saturation_UpperSat;
  } else if (rtb_SumofElements < SRV02_systemID_P.Saturation_LowerSat) {
    /* Saturate: '<Root>/Saturation' */
    SRV02_systemID_B.Saturation = SRV02_systemID_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<Root>/Saturation' */
    SRV02_systemID_B.Saturation = rtb_SumofElements;
  }

  /* End of Saturate: '<Root>/Saturation' */

  /* Saturate: '<S1>/Saturation' */
  if (SRV02_systemID_B.Saturation > SRV02_systemID_P.Saturation_UpperSat_l) {
    /* Saturate: '<S1>/Saturation' */
    SRV02_systemID_B.Saturation_b = SRV02_systemID_P.Saturation_UpperSat_l;
  } else if (SRV02_systemID_B.Saturation <
             SRV02_systemID_P.Saturation_LowerSat_j) {
    /* Saturate: '<S1>/Saturation' */
    SRV02_systemID_B.Saturation_b = SRV02_systemID_P.Saturation_LowerSat_j;
  } else {
    /* Saturate: '<S1>/Saturation' */
    SRV02_systemID_B.Saturation_b = SRV02_systemID_B.Saturation;
  }
...
RT_MODEL_SRV02_systemID_T *SRV02_systemID(void)
{
  ...
  /* External mode info */
  SRV02_systemID_M->Sizes.checksums[0] = (552174831U);
  SRV02_systemID_M->Sizes.checksums[1] = (727738906U);
  SRV02_systemID_M->Sizes.checksums[2] = (4285518102U);
  SRV02_systemID_M->Sizes.checksums[3] = (3254105771U);
...

  {
    ...
    SRV02_systemID_B.Saturation_b = 0.0;
  ...
  SRV02_systemID_M->Sizes.numBlocks = (15);/* Number of blocks */
  SRV02_systemID_M->Sizes.numBlockIO = (5);/* Number of block outputs */
  SRV02_systemID_M->Sizes.numBlockPrms = (175);/* Sum of parameter "widths" */
