    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(23)  = dumData; %prealloc
                    ...
                    ;% SRV02_systemID_P.Saturation_UpperSat_l
                    section.data(22).logicalSrcIdx = 25;
                    section.data(22).dtTransOffset = 120;

                    ;% SRV02_systemID_P.Saturation_LowerSat_j
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% SRV02_systemID_P.HILInitialize_CKChannels
                    section.data(1).logicalSrcIdx = 27;
                    section.data(1).dtTransOffset = 0;

                    ;% SRV02_systemID_P.HILInitialize_DOWatchdog
                    ...
                    ;% SRV02_systemID_P.HILInitialize_POModes
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% SRV02_systemID_P.HILInitialize_AIChannels
                    section.data(1).logicalSrcIdx = 31;
                    section.data(1).dtTransOffset = 0;

                    ;% SRV02_systemID_P.HILInitialize_AOChannels
                    section.data(2).logicalSrcIdx = 32;
                    section.data(2).dtTransOffset = 2;

                    ;% SRV02_systemID_P.HILInitialize_EIChannels
            ...
            section.data(38)  = dumData; %prealloc
                    ...
                    ;% SRV02_systemID_P.HILInitialize_Active
                    section.data(1).logicalSrcIdx = 35;
                    section.data(1).dtTransOffset = 0;

                    ;% SRV02_systemID_P.HILInitialize_AOTerminate
                    section.data(2).logicalSrcIdx = 36;
                    section.data(2).dtTransOffset = 1;

                    ;% SRV02_systemID_P.HILInitialize_AOExit
                    section.data(3).logicalSrcIdx = 37;
                    section.data(3).dtTransOffset = 2;

                    ;% SRV02_systemID_P.HILInitialize_DOTerminate
                    section.data(4).logicalSrcIdx = 38;
                    section.data(4).dtTransOffset = 3;

                    ;% SRV02_systemID_P.HILInitialize_DOExit
                    section.data(5).logicalSrcIdx = 39;
                    section.data(5).dtTransOffset = 4;

                    ;% SRV02_systemID_P.HILInitialize_POTerminate
                    section.data(6).logicalSrcIdx = 40;
                    section.data(6).dtTransOffset = 5;

                    ;% SRV02_systemID_P.HILInitialize_POExit
                    section.data(7).logicalSrcIdx = 41;
                    section.data(7).dtTransOffset = 6;

                    ;% SRV02_systemID_P.HILInitialize_CKPStart
                    section.data(8).logicalSrcIdx = 42;
                    section.data(8).dtTransOffset = 7;

                    ;% SRV02_systemID_P.HILInitialize_CKPEnter
                    section.data(9).logicalSrcIdx = 43;
                    section.data(9).dtTransOffset = 8;

                    ;% SRV02_systemID_P.HILInitialize_CKStart
                    section.data(10).logicalSrcIdx = 44;
                    section.data(10).dtTransOffset = 9;

                    ;% SRV02_systemID_P.HILInitialize_CKEnter
                    section.data(11).logicalSrcIdx = 45;
                    section.data(11).dtTransOffset = 10;

                    ;% SRV02_systemID_P.HILInitialize_AIPStart
                    section.data(12).logicalSrcIdx = 46;
                    section.data(12).dtTransOffset = 11;

                    ;% SRV02_systemID_P.HILInitialize_AIPEnter
                    section.data(13).logicalSrcIdx = 47;
                    section.data(13).dtTransOffset = 12;

                    ;% SRV02_systemID_P.HILInitialize_AOPStart
                    section.data(14).logicalSrcIdx = 48;
                    section.data(14).dtTransOffset = 13;

                    ;% SRV02_systemID_P.HILInitialize_AOPEnter
                    section.data(15).logicalSrcIdx = 49;
                    section.data(15).dtTransOffset = 14;

                    ;% SRV02_systemID_P.HILInitialize_AOStart
                    section.data(16).logicalSrcIdx = 50;
                    section.data(16).dtTransOffset = 15;

                    ;% SRV02_systemID_P.HILInitialize_AOEnter
                    section.data(17).logicalSrcIdx = 51;
                    section.data(17).dtTransOffset = 16;

                    ;% SRV02_systemID_P.HILInitialize_AOReset
                    section.data(18).logicalSrcIdx = 52;
                    section.data(18).dtTransOffset = 17;

                    ;% SRV02_systemID_P.HILInitialize_DOPStart
                    section.data(19).logicalSrcIdx = 53;
                    section.data(19).dtTransOffset = 18;

                    ;% SRV02_systemID_P.HILInitialize_DOPEnter
                    section.data(20).logicalSrcIdx = 54;
                    section.data(20).dtTransOffset = 19;

                    ;% SRV02_systemID_P.HILInitialize_DOStart
                    section.data(21).logicalSrcIdx = 55;
                    section.data(21).dtTransOffset = 20;

                    ;% SRV02_systemID_P.HILInitialize_DOEnter
                    section.data(22).logicalSrcIdx = 56;
                    section.data(22).dtTransOffset = 21;

                    ;% SRV02_systemID_P.HILInitialize_DOReset
                    section.data(23).logicalSrcIdx = 57;
                    section.data(23).dtTransOffset = 22;

                    ;% SRV02_systemID_P.HILInitialize_EIPStart
                    section.data(24).logicalSrcIdx = 58;
                    section.data(24).dtTransOffset = 23;

                    ;% SRV02_systemID_P.HILInitialize_EIPEnter
                    section.data(25).logicalSrcIdx = 59;
                    section.data(25).dtTransOffset = 24;

                    ;% SRV02_systemID_P.HILInitialize_EIStart
                    section.data(26).logicalSrcIdx = 60;
                    section.data(26).dtTransOffset = 25;

                    ;% SRV02_systemID_P.HILInitialize_EIEnter
                    section.data(27).logicalSrcIdx = 61;
                    section.data(27).dtTransOffset = 26;

                    ;% SRV02_systemID_P.HILInitialize_POPStart
                    section.data(28).logicalSrcIdx = 62;
                    section.data(28).dtTransOffset = 27;

                    ;% SRV02_systemID_P.HILInitialize_POPEnter
                    section.data(29).logicalSrcIdx = 63;
                    section.data(29).dtTransOffset = 28;

                    ;% SRV02_systemID_P.HILInitialize_POStart
                    section.data(30).logicalSrcIdx = 64;
                    section.data(30).dtTransOffset = 29;

                    ;% SRV02_systemID_P.HILInitialize_POEnter
                    section.data(31).logicalSrcIdx = 65;
                    section.data(31).dtTransOffset = 30;

                    ;% SRV02_systemID_P.HILInitialize_POReset
                    section.data(32).logicalSrcIdx = 66;
                    section.data(32).dtTransOffset = 31;

                    ;% SRV02_systemID_P.HILInitialize_OOReset
                    section.data(33).logicalSrcIdx = 67;
                    section.data(33).dtTransOffset = 32;

                    ;% SRV02_systemID_P.HILInitialize_DOFinal
                    section.data(34).logicalSrcIdx = 68;
                    section.data(34).dtTransOffset = 33;

                    ;% SRV02_systemID_P.HILInitialize_DOInitial
                    section.data(35).logicalSrcIdx = 69;
                    section.data(35).dtTransOffset = 34;

                    ;% SRV02_systemID_P.HILReadEncoder_Active
                    section.data(36).logicalSrcIdx = 70;
                    section.data(36).dtTransOffset = 35;

                    ;% SRV02_systemID_P.HILReadAnalog_Active
                    section.data(37).logicalSrcIdx = 71;
                    section.data(37).dtTransOffset = 36;

                    ;% SRV02_systemID_P.HILWrite_Active
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% SRV02_systemID_B.HILReadAnalog
    ...
    ;%*******************
        ...
        ;%
        ;% Auto data (SRV02_systemID_DW)
        ;%
            section.nData     = 7;
            section.data(7)  = dumData; %prealloc

                    ;% SRV02_systemID_DW.HILInitialize_AIMinimums
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% SRV02_systemID_DW.HILInitialize_AIMaximums
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 2;

                    ;% SRV02_systemID_DW.HILInitialize_AOMinimums
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 4;

                    ;% SRV02_systemID_DW.HILInitialize_AOMaximums
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 6;

                    ;% SRV02_systemID_DW.HILInitialize_AOVoltages
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 8;

                    ;% SRV02_systemID_DW.HILInitialize_FilterFrequency
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% SRV02_systemID_DW.HILReadAnalog_PWORK
                    section.data(2).logicalSrcIdx = 9;
                    section.data(2).dtTransOffset = 1;

                    ;% SRV02_systemID_DW.HILWrite_PWORK
    ...
    targMap.checksum0 = 552174831;
    targMap.checksum1 = 727738906;
    targMap.checksum2 = 4285518102;
    targMap.checksum3 = 3254105771;
