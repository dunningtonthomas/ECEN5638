###########################################################################
## Makefile generated for component 'SRV02_systemID'. 
## 
## Makefile     : SRV02_systemID.mk
## Generated on : Tue Feb 18 13:46:52 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SRV02_systemID.rt-win64
...
COMPILER_COMMAND_FILE     = SRV02_systemID_comp.rsp
CMD_FILE                  = SRV02_systemID.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SRV02_systemID.rt-win64
...
DEFINES_STANDARD = -DMODEL=SRV02_systemID -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID.c $(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID_data.c $(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID_main.c $(START_DIR)\SRV02_systemID_quarc_win64\rtGetInf.c $(START_DIR)\SRV02_systemID_quarc_win64\rtGetNaN.c $(START_DIR)\SRV02_systemID_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = SRV02_systemID.obj SRV02_systemID_data.obj SRV02_systemID_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\SRV02_systemID_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SRV02_systemID_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
SRV02_systemID.obj : "$(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID.c"


SRV02_systemID_data.obj : "$(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID_data.c"


SRV02_systemID_main.obj : "$(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_quarc_win64\SRV02_systemID_main.c"


rtGetInf.obj : "$(START_DIR)\SRV02_systemID_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\SRV02_systemID_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\SRV02_systemID_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_quarc_win64\rt_nonfinite.c"
