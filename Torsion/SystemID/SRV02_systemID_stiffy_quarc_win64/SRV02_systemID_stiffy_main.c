...
typedef RT_MODEL_SRV02_systemID_stiff_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * SRV02_systemID_stiffy(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(SRV02_systemID_stiffy_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: SRV02_systemID_stiffy -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
