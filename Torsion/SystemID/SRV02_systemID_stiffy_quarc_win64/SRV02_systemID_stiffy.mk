###########################################################################
## Makefile generated for component 'SRV02_systemID_stiffy'. 
## 
## Makefile     : SRV02_systemID_stiffy.mk
## Generated on : Tue Feb 18 14:26:59 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SRV02_systemID_stiffy.rt-win64
...
PRODUCT_NAME              = SRV02_systemID_stiffy
MAKEFILE                  = SRV02_systemID_stiffy.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\quarc_user\Desktop\GitRepos\ECEN5638\Torsion\SystemID
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = SRV02_systemID_stiffy_comp.rsp
CMD_FILE                  = SRV02_systemID_stiffy.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SRV02_systemID_stiffy.rt-win64
...
DEFINES_STANDARD = -DMODEL=SRV02_systemID_stiffy -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy.c $(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy_data.c $(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy_main.c $(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rtGetInf.c $(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rtGetNaN.c $(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = SRV02_systemID_stiffy.obj SRV02_systemID_stiffy_data.obj SRV02_systemID_stiffy_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\SRV02_systemID_stiffy_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SRV02_systemID_stiffy_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
SRV02_systemID_stiffy.obj : "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy.c"


SRV02_systemID_stiffy_data.obj : "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy_data.c"


SRV02_systemID_stiffy_main.obj : "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\SRV02_systemID_stiffy_main.c"


rtGetInf.obj : "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SRV02_systemID_stiffy_quarc_win64\rt_nonfinite.c"
