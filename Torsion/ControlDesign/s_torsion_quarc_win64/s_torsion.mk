###########################################################################
## Makefile generated for component 's_torsion'. 
## 
## Makefile     : s_torsion.mk
## Generated on : Thu Feb 27 13:52:05 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\s_torsion.rt-win64
...
COMPILER_COMMAND_FILE     = s_torsion_comp.rsp
CMD_FILE                  = s_torsion.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\s_torsion.rt-win64
...
DEFINES_STANDARD = -DMODEL=s_torsion -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\s_torsion_quarc_win64\rtGetInf.c $(START_DIR)\s_torsion_quarc_win64\rtGetNaN.c $(START_DIR)\s_torsion_quarc_win64\rt_nonfinite.c $(START_DIR)\s_torsion_quarc_win64\s_torsion.c $(START_DIR)\s_torsion_quarc_win64\s_torsion_data.c $(START_DIR)\s_torsion_quarc_win64\s_torsion_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj s_torsion.obj s_torsion_data.obj s_torsion_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\s_torsion_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\s_torsion_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\s_torsion_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_torsion_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\s_torsion_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_torsion_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\s_torsion_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_torsion_quarc_win64\rt_nonfinite.c"


s_torsion.obj : "$(START_DIR)\s_torsion_quarc_win64\s_torsion.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_torsion_quarc_win64\s_torsion.c"


s_torsion_data.obj : "$(START_DIR)\s_torsion_quarc_win64\s_torsion_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_torsion_quarc_win64\s_torsion_data.c"


s_torsion_main.obj : "$(START_DIR)\s_torsion_quarc_win64\s_torsion_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\s_torsion_quarc_win64\s_torsion_main.c"
