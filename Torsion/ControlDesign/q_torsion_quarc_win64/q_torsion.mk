###########################################################################
## Makefile generated for component 'q_torsion'. 
## 
## Makefile     : q_torsion.mk
## Generated on : Thu Feb 27 14:32:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_torsion.rt-win64
...
COMPILER_COMMAND_FILE     = q_torsion_comp.rsp
CMD_FILE                  = q_torsion.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_torsion.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_torsion -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_torsion_quarc_win64\q_torsion.c $(START_DIR)\q_torsion_quarc_win64\q_torsion_data.c $(START_DIR)\q_torsion_quarc_win64\q_torsion_main.c $(START_DIR)\q_torsion_quarc_win64\rtGetInf.c $(START_DIR)\q_torsion_quarc_win64\rtGetNaN.c $(START_DIR)\q_torsion_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_torsion.obj q_torsion_data.obj q_torsion_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_torsion_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_torsion_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_torsion.obj : "$(START_DIR)\q_torsion_quarc_win64\q_torsion.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_quarc_win64\q_torsion.c"


q_torsion_data.obj : "$(START_DIR)\q_torsion_quarc_win64\q_torsion_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_quarc_win64\q_torsion_data.c"


q_torsion_main.obj : "$(START_DIR)\q_torsion_quarc_win64\q_torsion_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_quarc_win64\q_torsion_main.c"


rtGetInf.obj : "$(START_DIR)\q_torsion_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_torsion_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_torsion_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_quarc_win64\rt_nonfinite.c"
