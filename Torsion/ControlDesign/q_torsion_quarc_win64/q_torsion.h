...
#ifndef q_torsion_h_
#define q_torsion_h_
#ifndef q_torsion_COMMON_INCLUDES_
#define q_torsion_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* q_torsion_COMMON_INCLUDES_ */

#include "q_torsion_types.h"
...
#define q_torsion_rtModel              RT_MODEL_q_torsion_T

/* Block signals (default storage) */
typedef struct {
  real_T RateLimiter;                  /* '<S5>/Rate Limiter' */
  real_T FSPS[4];                      /* '<Root>/FS // PS' */
  real_T DACBSaturationV;              /* '<S6>/DACB Saturation (V)' */
  real_T AmplifierGainVV;              /* '<S6>/Amplifier  Gain (V//V)' */
  real_T Gain[4];                      /* '<S10>/Gain' */
  real_T Gain_i[4];                    /* '<S9>/Gain' */
} B_q_torsion_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T DiscreteTransferFcn_states[2];/* '<S7>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_states_g[2];/* '<S8>/Discrete Transfer Fcn' */
  ...
  real_T DiscreteTransferFcn_tmp_d;    /* '<S8>/Discrete Transfer Fcn' */
  ...
  struct {
    void *LoggedData;
  } theta1deg_PWORK;                   /* '<S4>/theta1 (deg)' */

  struct {
    void *LoggedData;
  } theta2deg_PWORK;                   /* '<S4>/theta2 (deg)' */
...
#define rtB                            q_torsion_B
#define BlockIO                        B_q_torsion_T
#define rtP                            q_torsion_P
#define Parameters                     P_q_torsion_T
#define rtDWork                        q_torsion_DW
#define D_Work                         DW_q_torsion_T

/* Parameters (default storage) */
struct P_q_torsion_T_ {
  ...
  real_T VMAX_AMP;                     /* Variable: VMAX_AMP
                                        * Referenced by: '<S6>/Amplifier  Saturation (V)'
                                        */
  real_T VMAX_DAC;                     /* Variable: VMAX_DAC
                                        * Referenced by: '<S6>/DACB Saturation (V)'
                                        */
  ...
  real_T ConverttoVectorState_Gain[4]; /* Expression: [1,1,0,0]
                                        * Referenced by: '<S5>/Convert to  Vector State'
                                        */
  ...
  real_T DiscreteTransferFcn_InitialStat;/* Expression: 0
                                          * Referenced by: '<S7>/Discrete Transfer Fcn'
                                          */
  real_T DiscreteTransferFcn_NumCoef_h[3];/* Expression: numz
                                           * Referenced by: '<S8>/Discrete Transfer Fcn'
                                           */
  real_T DiscreteTransferFcn_DenCoef_k[3];/* Expression: denz
                                           * Referenced by: '<S8>/Discrete Transfer Fcn'
                                           */
...
extern P_q_torsion_T q_torsion_P;

/* Block signals (default storage) */
extern B_q_torsion_T q_torsion_B;

/* Block states (default storage) */
extern DW_q_torsion_T q_torsion_DW;

/* Model entry point functions */
extern void q_torsion_initialize(void);
extern void q_torsion_output(void);
extern void q_torsion_update(void);
extern void q_torsion_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_torsion_rtModel *q_torsion(void);
...
extern RT_MODEL_q_torsion_T *const q_torsion_M;
 ...
 *
 * '<Root>' : 'q_torsion'
 * '<S1>'   : 'q_torsion/1 DOF Torsion'
 * '<S2>'   : 'q_torsion/High-Gain Observer'
 * '<S3>'   : 'q_torsion/Powered by QUARC'
 * '<S4>'   : 'q_torsion/Scopes'
 * '<S5>'   : 'q_torsion/Setpoint'
 * '<S6>'   : 'q_torsion/1 DOF Torsion/Actuator Electrical  Dynamics'
 * '<S7>'   : 'q_torsion/High-Gain Observer/HPF: theta1_dot (rad//s)'
 * '<S8>'   : 'q_torsion/High-Gain Observer/HPF: theta2_dot (rad//s)'
 * '<S9>'   : 'q_torsion/Scopes/X: rad to deg'
 * '<S10>'  : 'q_torsion/Scopes/setpoint: rad to deg'
 * '<S11>'  : 'q_torsion/Setpoint/Degrees to Radians'
 */
#endif                                 /* q_torsion_h_ */
