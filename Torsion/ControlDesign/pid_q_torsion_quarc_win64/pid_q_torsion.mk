###########################################################################
## Makefile generated for component 'pid_q_torsion'. 
## 
## Makefile     : pid_q_torsion.mk
## Generated on : Tue Mar 04 15:29:19 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\pid_q_torsion.rt-win64
...
PRODUCT_NAME              = pid_q_torsion
MAKEFILE                  = pid_q_torsion.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\quarc_user\Desktop\GitRepos\ECEN5638\Torsion\ControlDesign
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = pid_q_torsion_comp.rsp
CMD_FILE                  = pid_q_torsion.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\pid_q_torsion.rt-win64
...
DEFINES_STANDARD = -DMODEL=pid_q_torsion -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion.c $(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion_data.c $(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion_main.c $(START_DIR)\pid_q_torsion_quarc_win64\rtGetInf.c $(START_DIR)\pid_q_torsion_quarc_win64\rtGetNaN.c $(START_DIR)\pid_q_torsion_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = pid_q_torsion.obj pid_q_torsion_data.obj pid_q_torsion_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\pid_q_torsion_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\pid_q_torsion_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
pid_q_torsion.obj : "$(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion.c"


pid_q_torsion_data.obj : "$(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion_data.c"


pid_q_torsion_main.obj : "$(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pid_q_torsion_quarc_win64\pid_q_torsion_main.c"


rtGetInf.obj : "$(START_DIR)\pid_q_torsion_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pid_q_torsion_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\pid_q_torsion_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pid_q_torsion_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\pid_q_torsion_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pid_q_torsion_quarc_win64\rt_nonfinite.c"
