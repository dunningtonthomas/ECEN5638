###########################################################################
## Makefile generated for component 'q_torsion_val'. 
## 
## Makefile     : q_torsion_val.mk
## Generated on : Thu Feb 20 14:12:11 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_torsion_val.rt-win64
...
COMPILER_COMMAND_FILE     = q_torsion_val_comp.rsp
CMD_FILE                  = q_torsion_val.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_torsion_val.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_torsion_val -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val.c $(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val_data.c $(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val_main.c $(START_DIR)\q_torsion_val_quarc_win64\rtGetInf.c $(START_DIR)\q_torsion_val_quarc_win64\rtGetNaN.c $(START_DIR)\q_torsion_val_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_torsion_val.obj q_torsion_val_data.obj q_torsion_val_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_torsion_val_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_torsion_val_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_torsion_val.obj : "$(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val.c"


q_torsion_val_data.obj : "$(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val_data.c"


q_torsion_val_main.obj : "$(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_val_quarc_win64\q_torsion_val_main.c"


rtGetInf.obj : "$(START_DIR)\q_torsion_val_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_val_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_torsion_val_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_val_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_torsion_val_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_torsion_val_quarc_win64\rt_nonfinite.c"
