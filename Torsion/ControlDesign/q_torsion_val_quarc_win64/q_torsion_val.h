...
#ifndef q_torsion_val_h_
#define q_torsion_val_h_
#ifndef q_torsion_val_COMMON_INCLUDES_
#define q_torsion_val_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* q_torsion_val_COMMON_INCLUDES_ */

#include "q_torsion_val_types.h"
...
#define q_torsion_val_rtModel          RT_MODEL_q_torsion_val_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } theta1deg_PWORK;                   /* '<Root>/theta1 (deg)' */

  struct {
    void *LoggedData;
  } theta2deg_PWORK;                   /* '<Root>/theta2 (deg)' */
...
#define rtB                            q_torsion_val_B
#define BlockIO                        B_q_torsion_val_T
#define rtX                            q_torsion_val_X
#define ContinuousStates               X_q_torsion_val_T
#define rtXdot                         q_torsion_val_XDot
#define StateDerivatives               XDot_q_torsion_val_T
#define tXdis                          q_torsion_val_XDis
#define StateDisabled                  XDis_q_torsion_val_T
#define rtP                            q_torsion_val_P
#define Parameters                     P_q_torsion_val_T
#define rtDWork                        q_torsion_val_DW
#define D_Work                         DW_q_torsion_val_T

/* Parameters (default storage) */
struct P_q_torsion_val_T_ {
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: 2.5
                                        * Referenced by: '<Root>/Step'
                                        */
  ...
  real_T Step1_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step1_YFinal;                 /* Expression: -2.5
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T AmplitudeV_Gain;              /* Expression: 2
...
struct tag_RTM_q_torsion_val_T {
  const char_T *path;
...
extern P_q_torsion_val_T q_torsion_val_P;

/* Block signals (default storage) */
extern B_q_torsion_val_T q_torsion_val_B;

/* Continuous states (default storage) */
extern X_q_torsion_val_T q_torsion_val_X;

/* Disabled states (default storage) */
extern XDis_q_torsion_val_T q_torsion_val_XDis;

/* Block states (default storage) */
extern DW_q_torsion_val_T q_torsion_val_DW;

/* Model entry point functions */
extern void q_torsion_val_initialize(void);
extern void q_torsion_val_output(void);
extern void q_torsion_val_update(void);
extern void q_torsion_val_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_torsion_val_rtModel *q_torsion_val(void);
...
extern RT_MODEL_q_torsion_val_T *const q_torsion_val_M;
 ...
 *
 * '<Root>' : 'q_torsion_val'
 * '<S1>'   : 'q_torsion_val/1 DOF Torsion'
 * '<S2>'   : 'q_torsion_val/th1: rad to deg'
 * '<S3>'   : 'q_torsion_val/th2: rad to deg'
 * '<S4>'   : 'q_torsion_val/1 DOF Torsion/Actuator Electrical  Dynamics'
 */
#endif                                 /* q_torsion_val_h_ */
